...
module MenhirBasics = struct
  ...
  type token = 
    ...
    | TSUBDIR
    | TSTRING of (
# 38 "hcl/config_parser.mly"
      (string)
# 26 "hcl/config_parser.ml"
  )
    | TSTAR
    | TSPFLAGS
    | TSORT
    ...
    | TLCB
    | TInt of (
# 35 "hcl/config_parser.mly"
      (int)
# 59 "hcl/config_parser.ml"
  )
    | TId of (
# 37 "hcl/config_parser.mly"
      (string)
# 64 "hcl/config_parser.ml"
  )
    | TINFO
    | TGROUP
    | TGRAPH
    | TFloat of (
# 36 "hcl/config_parser.mly"
      (float)
# 72 "hcl/config_parser.ml"
  )
    | TFORMAT
    | TFOOTER
    | TFINDCMD
    ...
    | TCLEANCOLOR
    | TBOOL of (
# 39 "hcl/config_parser.mly"
      (bool)
# 97 "hcl/config_parser.ml"
  )
    | TAUTHOR
    | EOF
...
let _menhir_action_002 =
  fun b r v ->
    (
# 105 "hcl/config_parser.mly"
                                                   ( Ast_config.Color(r,v,b) )
# 587 "hcl/config_parser.ml"
     : (Ast_config.attr))

let _menhir_action_003 =
  fun () ->
    (
# 106 "hcl/config_parser.mly"
                                                   ( Ast_config.Correl("none") )
# 595 "hcl/config_parser.ml"
     : (Ast_config.attr))

let _menhir_action_004 =
  fun dft ->
    (
# 107 "hcl/config_parser.mly"
                                                   ( Ast_config.Correl(dft) )
# 603 "hcl/config_parser.ml"
     : (Ast_config.attr))

let _menhir_action_005 =
  fun b r v ->
    (
# 108 "hcl/config_parser.mly"
                                                   ( Ast_config.CleanColor(r,v,b))
# 611 "hcl/config_parser.ml"
     : (Ast_config.attr))

let _menhir_action_006 =
  fun dft ->
    (
# 109 "hcl/config_parser.mly"
                                                   ( Ast_config.DftPattern(dft))
# 619 "hcl/config_parser.ml"
     : (Ast_config.attr))

let _menhir_action_007 =
  fun b r v ->
    (
# 110 "hcl/config_parser.mly"
                                                   ( Ast_config.PatternColor(r,v,b))
# 627 "hcl/config_parser.ml"
     : (Ast_config.attr))

let _menhir_action_008 =
  fun e ->
    (
# 111 "hcl/config_parser.mly"
                                                   ( Ast_config.Data(e))
# 635 "hcl/config_parser.ml"
     : (Ast_config.attr))

let _menhir_action_009 =
  fun d ->
    (
# 112 "hcl/config_parser.mly"
                                                   ( Ast_config.Dir(d))
# 643 "hcl/config_parser.ml"
     : (Ast_config.attr))

let _menhir_action_010 =
  fun d ->
    (
# 113 "hcl/config_parser.mly"
                                                   ( Ast_config.SubDir(d))
# 651 "hcl/config_parser.ml"
     : (Ast_config.attr))

let _menhir_action_011 =
  fun f ->
    (
# 114 "hcl/config_parser.mly"
                                                   ( Ast_config.Factor(f))
# 659 "hcl/config_parser.ml"
     : (Ast_config.attr))

let _menhir_action_012 =
  fun f ->
    (
# 116 "hcl/config_parser.mly"
    ( if f = "" then Ast_config.File(None) else Ast_config.File(Some f) )
# 667 "hcl/config_parser.ml"
     : (Ast_config.attr))

let _menhir_action_013 =
  fun () ->
    (
# 117 "hcl/config_parser.mly"
                                                   ( Ast_config.File(None))
# 675 "hcl/config_parser.ml"
     : (Ast_config.attr))

let _menhir_action_014 =
  fun b ->
    (
# 118 "hcl/config_parser.mly"
                                                   ( Ast_config.Filename(b))
# 683 "hcl/config_parser.ml"
     : (Ast_config.attr))

let _menhir_action_015 =
  fun l ->
    (
# 119 "hcl/config_parser.mly"
                                                   ( Ast_config.Footer(l))
# 691 "hcl/config_parser.ml"
     : (Ast_config.attr))

let _menhir_action_016 =
  fun dft ->
    (
# 120 "hcl/config_parser.mly"
                                                   ( Ast_config.Format(dft) )
# 699 "hcl/config_parser.ml"
     : (Ast_config.attr))

let _menhir_action_017 =
  fun b ->
    (
# 121 "hcl/config_parser.mly"
                                                   ( Ast_config.Info(b))
# 707 "hcl/config_parser.ml"
     : (Ast_config.attr))

let _menhir_action_018 =
  fun l ->
    (
# 122 "hcl/config_parser.mly"
                                                   ( Ast_config.Legend(l))
# 715 "hcl/config_parser.ml"
     : (Ast_config.attr))

let _menhir_action_019 =
  fun l ->
    (
# 123 "hcl/config_parser.mly"
                                                   ( Ast_config.XLegend(to_jgraph_fmt l))
# 723 "hcl/config_parser.ml"
     : (Ast_config.attr))

let _menhir_action_020 =
  fun l ->
    (
# 124 "hcl/config_parser.mly"
                                                   ( Ast_config.YLegend(to_jgraph_fmt l))
# 731 "hcl/config_parser.ml"
     : (Ast_config.attr))

let _menhir_action_021 =
  fun f ->
    (
# 125 "hcl/config_parser.mly"
                                                   ( Ast_config.YLegendFactor(f))
# 739 "hcl/config_parser.ml"
     : (Ast_config.attr))

let _menhir_action_022 =
  fun () ->
    (
# 126 "hcl/config_parser.mly"
                                                   ( Ast_config.LineType("none"))
# 747 "hcl/config_parser.ml"
     : (Ast_config.attr))

let _menhir_action_023 =
  fun s ->
    (
# 127 "hcl/config_parser.mly"
                                                   ( Ast_config.LineType(s))
# 755 "hcl/config_parser.ml"
     : (Ast_config.attr))

let _menhir_action_024 =
  fun () ->
    (
# 128 "hcl/config_parser.mly"
                                                   ( Ast_config.MarkType("none"))
# 763 "hcl/config_parser.ml"
     : (Ast_config.attr))

let _menhir_action_025 =
  fun m ->
    (
# 129 "hcl/config_parser.mly"
                                                   ( Ast_config.MarkType(m))
# 771 "hcl/config_parser.ml"
     : (Ast_config.attr))

let _menhir_action_026 =
  fun v ->
    (
# 130 "hcl/config_parser.mly"
                                                   ( Ast_config.MarkSize(v))
# 779 "hcl/config_parser.ml"
     : (Ast_config.attr))

let _menhir_action_027 =
  fun t ->
    (
# 131 "hcl/config_parser.mly"
                                                   ( Ast_config.XAxis(t))
# 787 "hcl/config_parser.ml"
     : (Ast_config.attr))

let _menhir_action_028 =
  fun v ->
    (
# 132 "hcl/config_parser.mly"
                                                   ( Ast_config.XMin(v))
# 795 "hcl/config_parser.ml"
     : (Ast_config.attr))

let _menhir_action_029 =
  fun t ->
    (
# 133 "hcl/config_parser.mly"
                                                   ( Ast_config.YAxis(t))
# 803 "hcl/config_parser.ml"
     : (Ast_config.attr))

let _menhir_action_030 =
  fun b r v ->
    (
# 134 "hcl/config_parser.mly"
                                                   ( Ast_config.NotExistColor(r,v,b))
# 811 "hcl/config_parser.ml"
     : (Ast_config.attr))

let _menhir_action_031 =
  fun prj ->
    (
# 135 "hcl/config_parser.mly"
                                                   ( Ast_config.DftProject(prj))
# 819 "hcl/config_parser.ml"
     : (Ast_config.attr))

let _menhir_action_032 =
  fun b ->
    (
# 136 "hcl/config_parser.mly"
                                                   ( Ast_config.Author(b))
# 827 "hcl/config_parser.ml"
     : (Ast_config.attr))

let _menhir_action_033 =
  fun b ->
    (
# 137 "hcl/config_parser.mly"
                                                   ( Ast_config.Prune(b))
# 835 "hcl/config_parser.ml"
     : (Ast_config.attr))

let _menhir_action_034 =
  fun b ->
    (
# 138 "hcl/config_parser.mly"
                                                   ( Ast_config.Ratio(b))
# 843 "hcl/config_parser.ml"
     : (Ast_config.attr))

let _menhir_action_035 =
  fun vs ->
    (
# 139 "hcl/config_parser.mly"
                                                   (
  match vs with
      (name, _,_)::_ ->
...
# 856 "hcl/config_parser.ml"
     : (Ast_config.attr))

let _menhir_action_036 =
  fun re ->
    (
# 145 "hcl/config_parser.mly"
                                                   ( Ast_config.VersionRE (re))
# 864 "hcl/config_parser.ml"
     : (Ast_config.attr))

let _menhir_action_037 =
  fun v ->
    (
# 146 "hcl/config_parser.mly"
                                                   ( Ast_config.VMin(v))
# 872 "hcl/config_parser.ml"
     : (Ast_config.attr))

let _menhir_action_038 =
  fun v ->
    (
# 147 "hcl/config_parser.mly"
                                                   ( Ast_config.LOCALSCM(v))
# 880 "hcl/config_parser.ml"
     : (Ast_config.attr))

let _menhir_action_039 =
  fun v ->
    (
# 148 "hcl/config_parser.mly"
                                                   ( Ast_config.PUBLICSCM(v))
# 888 "hcl/config_parser.ml"
     : (Ast_config.attr))

let _menhir_action_040 =
  fun f ->
    (
# 149 "hcl/config_parser.mly"
                                                   ( Ast_config.SPFlags(f))
# 896 "hcl/config_parser.ml"
     : (Ast_config.attr))

let _menhir_action_041 =
  fun b ->
    (
# 150 "hcl/config_parser.mly"
                                                   ( Ast_config.Sort(b))
# 904 "hcl/config_parser.ml"
     : (Ast_config.attr))

let _menhir_action_042 =
  fun x y ->
    (
# 151 "hcl/config_parser.mly"
                                                   ( Ast_config.Size(x,y))
# 912 "hcl/config_parser.ml"
     : (Ast_config.attr))

let _menhir_action_043 =
  fun atts ->
    (
# 154 "hcl/config_parser.mly"
                            (atts)
# 920 "hcl/config_parser.ml"
...
let _menhir_action_044 =
  fun _endpos_p_ _startpos__1_ p ->
    ...
    (
# 175 "hcl/config_parser.mly"
                                   ( (Some p,None  ,   [], Misc.getpos _startpos__1_ _endofs) )
# 930 "hcl/config_parser.ml"
     : (Ast_config.curve))
...
let _menhir_action_046 =
  fun _endpos_d_ _startpos__1_ d ->
    ...
    let _endofs = _endpos.Lexing.pos_cnum in
    (
# 177 "hcl/config_parser.mly"
                                   ( (None  ,Some d,   [], Misc.getpos _startpos__1_ _endofs) )
# 950 "hcl/config_parser.ml"
     : (Ast_config.curve))
...
let _menhir_action_049 =
  fun _endpos_d_ _startpos__1_ d p ->
    ...
    let _endofs = _endpos.Lexing.pos_cnum in
    (
# 182 "hcl/config_parser.mly"
    ( (Some p, Some d, [], Misc.getpos _startpos__1_ _endofs) )
# 980 "hcl/config_parser.ml"
     : (Ast_config.curve))
...
let _menhir_action_051 =
  fun _endpos__2_ _startpos__1_ ->
    ...
    let _endofs = _endpos.Lexing.pos_cnum in
    (
# 186 "hcl/config_parser.mly"
    ( (None, None, [], Misc.getpos _startpos__1_ _endofs) )
# 1000 "hcl/config_parser.ml"
     : (Ast_config.curve))

let _menhir_action_052 =
  fun d m y ->
    (
# 165 "hcl/config_parser.mly"
                                                        ( Some (build_date m d y)  )
# 1008 "hcl/config_parser.ml"
     : (Unix.tm option))

let _menhir_action_053 =
  fun descExperiment name ->
    (
# 84 "hcl/config_parser.mly"
                                                  (Setup.addExp name (descExperiment))
# 1016 "hcl/config_parser.ml"
     : (unit))

let _menhir_action_054 =
  fun d ->
    (
# 246 "hcl/config_parser.mly"
                                     ( Ast_config.Pattern d     )
# 1024 "hcl/config_parser.ml"
     : (Ast_config.expression))

let _menhir_action_055 =
  fun p ->
    (
# 247 "hcl/config_parser.mly"
                                     ( Ast_config.Project p     )
# 1032 "hcl/config_parser.ml"
     : (Ast_config.expression))

let _menhir_action_056 =
  fun f ->
    (
# 248 "hcl/config_parser.mly"
                                     ( Ast_config.Cst f         )
# 1040 "hcl/config_parser.ml"
     : (Ast_config.expression))

let _menhir_action_057 =
  fun e ->
    (
# 249 "hcl/config_parser.mly"
                                     ( e                        )
# 1048 "hcl/config_parser.ml"
     : (Ast_config.expression))

let _menhir_action_058 =
  fun e1 e2 ->
    (
# 250 "hcl/config_parser.mly"
                                     ( Ast_config.Plus(e1, e2)  )
# 1056 "hcl/config_parser.ml"
     : (Ast_config.expression))

let _menhir_action_059 =
  fun e1 e2 ->
    (
# 251 "hcl/config_parser.mly"
                                     ( Ast_config.Minus(e1, e2) )
# 1064 "hcl/config_parser.ml"
     : (Ast_config.expression))

let _menhir_action_060 =
  fun e1 e2 ->
    (
# 252 "hcl/config_parser.mly"
                                     ( Ast_config.Mul(e1, e2)   )
# 1072 "hcl/config_parser.ml"
     : (Ast_config.expression))

let _menhir_action_061 =
  fun e1 e2 ->
    (
# 253 "hcl/config_parser.mly"
                                     ( Ast_config.Div(e1, e2)   )
# 1080 "hcl/config_parser.ml"
     : (Ast_config.expression))

let _menhir_action_062 =
  fun f ->
    (
# 197 "hcl/config_parser.mly"
                  ( f                 )
# 1088 "hcl/config_parser.ml"
     : (float))

let _menhir_action_063 =
  fun i ->
    (
# 198 "hcl/config_parser.mly"
                  ( float_of_int i    )
# 1096 "hcl/config_parser.ml"
     : (float))

let _menhir_action_064 =
  fun f ->
    (
# 199 "hcl/config_parser.mly"
                  ( -. f              )
# 1104 "hcl/config_parser.ml"
     : (float))

let _menhir_action_065 =
  fun i ->
    (
# 200 "hcl/config_parser.mly"
                  ( -. float_of_int i )
# 1112 "hcl/config_parser.ml"
     : (float))

let _menhir_action_066 =
  fun date name size ->
    (
# 162 "hcl/config_parser.mly"
                                                             ( (name, date, size) )
# 1120 "hcl/config_parser.ml"
     : (Ast_config.version))

let _menhir_action_067 =
  fun p ->
    (
# 72 "hcl/config_parser.mly"
                                       ( Setup.setPrefix(p))
# 1128 "hcl/config_parser.ml"
     : (unit))

let _menhir_action_068 =
  fun p ->
    (
# 73 "hcl/config_parser.mly"
                                       ( Setup.setSmatchDir(p))
# 1136 "hcl/config_parser.ml"
     : (unit))

let _menhir_action_069 =
  fun p ->
    (
# 74 "hcl/config_parser.mly"
                                       ( Setup.setPrjDir(p))
# 1144 "hcl/config_parser.ml"
     : (unit))

let _menhir_action_070 =
  fun p ->
    (
# 75 "hcl/config_parser.mly"
                                       ( Setup.setResultsDir(p))
# 1152 "hcl/config_parser.ml"
     : (unit))

let _menhir_action_071 =
  fun p ->
    (
# 76 "hcl/config_parser.mly"
                                       ( Setup.setWebsiteDir(p))
# 1160 "hcl/config_parser.ml"
     : (unit))

let _menhir_action_072 =
  fun c ->
    (
# 77 "hcl/config_parser.mly"
                                       ( Setup.setFindCmd(c))
# 1168 "hcl/config_parser.ml"
     : (unit))

let _menhir_action_073 =
  fun c ->
    (
# 78 "hcl/config_parser.mly"
                                       ( Setup.setFindChild(c))
# 1176 "hcl/config_parser.ml"
     : (unit))

let _menhir_action_074 =
  fun f ->
    (
# 79 "hcl/config_parser.mly"
                                       ( Setup.setSPFlags(f))
# 1184 "hcl/config_parser.ml"
     : (unit))

let _menhir_action_075 =
  fun c ->
    (
# 80 "hcl/config_parser.mly"
                                       ( Setup.setCPUcore(c))
# 1192 "hcl/config_parser.ml"
     : (unit))

let _menhir_action_076 =
  fun s ->
    (
# 81 "hcl/config_parser.mly"
                                       ( Setup.setDBConn(s))
# 1200 "hcl/config_parser.ml"
     : (unit))

let _menhir_action_077 =
  fun i ->
    (
# 203 "hcl/config_parser.mly"
                           (        i        )
# 1208 "hcl/config_parser.ml"
     : (string))

let _menhir_action_078 =
  fun () ->
    (
# 204 "hcl/config_parser.mly"
                           ( "nooccurcolor"  )
# 1216 "hcl/config_parser.ml"
     : (string))

let _menhir_action_079 =
  fun () ->
    (
# 205 "hcl/config_parser.mly"
                           ( "patterns"      )
# 1224 "hcl/config_parser.ml"
     : (string))

let _menhir_action_080 =
  fun () ->
    (
# 206 "hcl/config_parser.mly"
                           ( "color"         )
# 1232 "hcl/config_parser.ml"
     : (string))

let _menhir_action_081 =
  fun () ->
    (
# 207 "hcl/config_parser.mly"
                           ( "correl"        )
# 1240 "hcl/config_parser.ml"
     : (string))

let _menhir_action_082 =
  fun () ->
    (
# 208 "hcl/config_parser.mly"
                           ( "cpucore"       )
# 1248 "hcl/config_parser.ml"
     : (string))

let _menhir_action_083 =
  fun () ->
    (
# 209 "hcl/config_parser.mly"
                           ( "curve"         )
# 1256 "hcl/config_parser.ml"
     : (string))

let _menhir_action_084 =
  fun () ->
    (
# 210 "hcl/config_parser.mly"
                           ( "data"          )
# 1264 "hcl/config_parser.ml"
     : (string))

let _menhir_action_085 =
  fun () ->
    (
# 211 "hcl/config_parser.mly"
                           ( "dir"           )
# 1272 "hcl/config_parser.ml"
     : (string))

let _menhir_action_086 =
  fun () ->
    (
# 212 "hcl/config_parser.mly"
                           ( "factor"        )
# 1280 "hcl/config_parser.ml"
     : (string))

let _menhir_action_087 =
  fun () ->
    (
# 213 "hcl/config_parser.mly"
                           ( "file"          )
# 1288 "hcl/config_parser.ml"
     : (string))

let _menhir_action_088 =
  fun () ->
    (
# 214 "hcl/config_parser.mly"
                           ( "filename"      )
# 1296 "hcl/config_parser.ml"
     : (string))

let _menhir_action_089 =
  fun () ->
    (
# 215 "hcl/config_parser.mly"
                           ( "graph"         )
# 1304 "hcl/config_parser.ml"
     : (string))

let _menhir_action_090 =
  fun () ->
    (
# 216 "hcl/config_parser.mly"
                           ( "group"         )
# 1312 "hcl/config_parser.ml"
     : (string))

let _menhir_action_091 =
  fun () ->
    (
# 217 "hcl/config_parser.mly"
                           ( "info"          )
# 1320 "hcl/config_parser.ml"
     : (string))

let _menhir_action_092 =
  fun () ->
    (
# 218 "hcl/config_parser.mly"
                           ( "legend"        )
# 1328 "hcl/config_parser.ml"
     : (string))

let _menhir_action_093 =
  fun () ->
    (
# 219 "hcl/config_parser.mly"
                           ( "linestyle"     )
# 1336 "hcl/config_parser.ml"
     : (string))

let _menhir_action_094 =
  fun () ->
    (
# 220 "hcl/config_parser.mly"
                           ( "marktype"      )
# 1344 "hcl/config_parser.ml"
     : (string))

let _menhir_action_095 =
  fun () ->
    (
# 221 "hcl/config_parser.mly"
                           ( "none"          )
# 1352 "hcl/config_parser.ml"
     : (string))

let _menhir_action_096 =
  fun () ->
    (
# 222 "hcl/config_parser.mly"
                           ( "notexistcolor" )
# 1360 "hcl/config_parser.ml"
     : (string))

let _menhir_action_097 =
  fun () ->
    (
# 223 "hcl/config_parser.mly"
                           ( "pattern"       )
# 1368 "hcl/config_parser.ml"
     : (string))

let _menhir_action_098 =
  fun () ->
    (
# 224 "hcl/config_parser.mly"
                           ( "findcmd"       )
# 1376 "hcl/config_parser.ml"
     : (string))

let _menhir_action_099 =
  fun () ->
    (
# 225 "hcl/config_parser.mly"
                           ( "findchild"     )
# 1384 "hcl/config_parser.ml"
     : (string))

let _menhir_action_100 =
  fun () ->
    (
# 226 "hcl/config_parser.mly"
                           ( "format"        )
# 1392 "hcl/config_parser.ml"
     : (string))

let _menhir_action_101 =
  fun () ->
    (
# 227 "hcl/config_parser.mly"
                           ( "occurcolor"    )
# 1400 "hcl/config_parser.ml"
     : (string))

let _menhir_action_102 =
  fun () ->
    (
# 228 "hcl/config_parser.mly"
                           ( "prefix"        )
# 1408 "hcl/config_parser.ml"
     : (string))

let _menhir_action_103 =
  fun () ->
    (
# 229 "hcl/config_parser.mly"
                           ( "project"       )
# 1416 "hcl/config_parser.ml"
     : (string))

let _menhir_action_104 =
  fun () ->
    (
# 230 "hcl/config_parser.mly"
                           ( "projects"      )
# 1424 "hcl/config_parser.ml"
     : (string))

let _menhir_action_105 =
  fun () ->
    (
# 231 "hcl/config_parser.mly"
                           ( "ratio"         )
# 1432 "hcl/config_parser.ml"
     : (string))

let _menhir_action_106 =
  fun () ->
    (
# 232 "hcl/config_parser.mly"
                           ( "results"       )
# 1440 "hcl/config_parser.ml"
     : (string))

let _menhir_action_107 =
  fun () ->
    (
# 233 "hcl/config_parser.mly"
                           ( "size"          )
# 1448 "hcl/config_parser.ml"
     : (string))

let _menhir_action_108 =
  fun () ->
    (
# 234 "hcl/config_parser.mly"
                           ( "sort"          )
# 1456 "hcl/config_parser.ml"
     : (string))

let _menhir_action_109 =
  fun () ->
    (
# 235 "hcl/config_parser.mly"
                           ( "flags"         )
# 1464 "hcl/config_parser.ml"
     : (string))

let _menhir_action_110 =
  fun () ->
    (
# 236 "hcl/config_parser.mly"
                           ( "versions"      )
# 1472 "hcl/config_parser.ml"
     : (string))

let _menhir_action_111 =
  fun () ->
    (
# 237 "hcl/config_parser.mly"
                           ( "website"       )
# 1480 "hcl/config_parser.ml"
     : (string))

let _menhir_action_112 =
  fun () ->
    (
# 238 "hcl/config_parser.mly"
                           ( "xaxis"         )
# 1488 "hcl/config_parser.ml"
     : (string))

let _menhir_action_113 =
  fun () ->
    (
# 239 "hcl/config_parser.mly"
                           ( "xlegend"       )
# 1496 "hcl/config_parser.ml"
     : (string))

let _menhir_action_114 =
  fun () ->
    (
# 240 "hcl/config_parser.mly"
                           ( "yaxis"         )
# 1504 "hcl/config_parser.ml"
     : (string))

let _menhir_action_115 =
  fun () ->
    (
# 241 "hcl/config_parser.mly"
                           ( "ylegend"       )
# 1512 "hcl/config_parser.ml"
     : (string))

let _menhir_action_116 =
  fun () ->
    (
# 242 "hcl/config_parser.mly"
                           ( "ylegendfactor" )
# 1520 "hcl/config_parser.ml"
     : (string))

let _menhir_action_117 =
  fun b ->
    (
# 243 "hcl/config_parser.mly"
                           ( if b then "true" else "false" )
# 1528 "hcl/config_parser.ml"
     : (string))

let _menhir_action_118 =
  fun atts cs name ->
    (
# 171 "hcl/config_parser.mly"
                                                             ( Setup.addGph name (atts,Ast_config.Curves(cs)) )
# 1536 "hcl/config_parser.ml"
     : (unit))

let _menhir_action_119 =
  fun atts gs name ->
    (
# 172 "hcl/config_parser.mly"
                                                                      ( Setup.addGph name (atts,Ast_config.Groups(gs)) )
# 1544 "hcl/config_parser.ml"
     : (unit))

let _menhir_action_120 =
  fun cs name ->
    (
# 189 "hcl/config_parser.mly"
                                               ( Ast_config.GrpCurve(name,cs))
# 1552 "hcl/config_parser.ml"
     : (Ast_config.group))
...
# 210 "<standard.mly>"
    ( x :: xs )
# 1722 "hcl/config_parser.ml"
     : (Ast_config.version list))

let _menhir_action_142 =
  fun () ->
    (
# 59 "hcl/config_parser.mly"
                    ( )
# 1730 "hcl/config_parser.ml"
     : (unit))
...
# 240 "<standard.mly>"
    ( x :: xs )
# 1858 "hcl/config_parser.ml"
     : (string list))

let _menhir_action_159 =
  fun () ->
    (
# 62 "hcl/config_parser.mly"
          ()
# 1866 "hcl/config_parser.ml"
     : (unit))

let _menhir_action_160 =
  fun () ->
    (
# 63 "hcl/config_parser.mly"
          ()
# 1874 "hcl/config_parser.ml"
     : (unit))

let _menhir_action_161 =
  fun () ->
    (
# 64 "hcl/config_parser.mly"
          ()
# 1882 "hcl/config_parser.ml"
     : (unit))

let _menhir_action_162 =
  fun () ->
    (
# 65 "hcl/config_parser.mly"
             ()
# 1890 "hcl/config_parser.ml"
     : (unit))

let _menhir_action_163 =
  fun () ->
    (
# 66 "hcl/config_parser.mly"
          ()
# 1898 "hcl/config_parser.ml"
     : (unit))

let _menhir_action_164 =
  fun desc ->
    (
# 157 "hcl/config_parser.mly"
                                             ( desc )
# 1906 "hcl/config_parser.ml"
     : (Ast_config.version))

let _menhir_action_165 =
  fun date name ->
    (
# 158 "hcl/config_parser.mly"
                                             ( (name, date, 0) )
# 1914 "hcl/config_parser.ml"
     : (Ast_config.version))

let _menhir_action_166 =
  fun name ->
    (
# 159 "hcl/config_parser.mly"
                                             ( (name, None, 0) )
# 1922 "hcl/config_parser.ml"
     : (Ast_config.version))
