...
module MenhirBasics = struct
  ...
  type token = 
    ...
    | TTODO
    | TTEXT of (
# 11 "diff+org/org_parser.mly"
      (string)
# 20 "diff+org/org_parser.ml"
  )
    | TSTODO
    | TSTAR
    | TSPACE
    ...
    | TLAB
    | TInt of (
# 10 "diff+org/org_parser.mly"
      (int)
# 36 "diff+org/org_parser.ml"
  )
    | TId of (
# 11 "diff+org/org_parser.mly"
      (string)
# 41 "diff+org/org_parser.ml"
  )
    | TIGNORED
    | THASHPLUS
    | TFP
...
# 1 "diff+org/org_parser.mly"
  


# 63 "diff+org/org_parser.ml"
...
let _menhir_action_03 =
  fun e1 e2 ->
    (
# 65 "diff+org/org_parser.mly"
                                          ( e1 ^ (String.concat "" e2))
# 280 "diff+org/org_parser.ml"
     : (string))

let _menhir_action_04 =
  fun e ->
    (
# 66 "diff+org/org_parser.mly"
                                          ( "=" ^ (String.concat "" e))
# 288 "diff+org/org_parser.ml"
     : (string))

let _menhir_action_05 =
  fun () ->
    (
# 67 "diff+org/org_parser.mly"
                                          ( "config"        )
# 296 "diff+org/org_parser.ml"
     : (string))

let _menhir_action_06 =
  fun e ->
    (
# 68 "diff+org/org_parser.mly"
                                          ( string_of_int e )
# 304 "diff+org/org_parser.ml"
     : (string))

let _menhir_action_07 =
  fun e ->
    (
# 69 "diff+org/org_parser.mly"
                                          (e               )
# 312 "diff+org/org_parser.ml"
     : (string))

let _menhir_action_08 =
  fun ops p t ->
    (
# 55 "diff+org/org_parser.mly"
                                     ( (p, ops, t) )
# 320 "diff+org/org_parser.ml"
     : (Ast_org.link))
...
# 210 "<standard.mly>"
    ( x :: xs )
# 400 "diff+org/org_parser.ml"
     : (string list))

let _menhir_action_19 =
  fun () ->
    (
# 32 "diff+org/org_parser.mly"
              ()
# 408 "diff+org/org_parser.ml"
     : (unit))

let _menhir_action_20 =
  fun () ->
    (
# 33 "diff+org/org_parser.mly"
              ()
# 416 "diff+org/org_parser.ml"
     : (unit))

let _menhir_action_21 =
  fun () ->
    (
# 34 "diff+org/org_parser.mly"
              ()
# 424 "diff+org/org_parser.ml"
     : (unit))

let _menhir_action_22 =
  fun () ->
    (
# 35 "diff+org/org_parser.mly"
              ()
# 432 "diff+org/org_parser.ml"
     : (unit))

let _menhir_action_23 =
  fun () ->
    (
# 36 "diff+org/org_parser.mly"
              ()
# 440 "diff+org/org_parser.ml"
     : (unit))

let _menhir_action_24 =
  fun () ->
    (
# 37 "diff+org/org_parser.mly"
              ()
# 448 "diff+org/org_parser.ml"
     : (unit))

let _menhir_action_25 =
  fun () ->
    (
# 38 "diff+org/org_parser.mly"
              ()
# 456 "diff+org/org_parser.ml"
     : (unit))

let _menhir_action_26 =
  fun () ->
    (
# 39 "diff+org/org_parser.mly"
              ()
# 464 "diff+org/org_parser.ml"
     : (unit))
...
# 220 "<standard.mly>"
    ( x :: xs )
# 512 "diff+org/org_parser.ml"
     : (unit list))

let _menhir_action_33 =
  fun v ->
    (
# 76 "diff+org/org_parser.mly"
                                 (v)
# 520 "diff+org/org_parser.ml"
     : (Ast_org.orgoption))

let _menhir_action_34 =
  fun l level r s ->
    (
# 43 "diff+org/org_parser.mly"
    ( let lvl = List.length level in
      let new_r = Str.global_replace (Str.regexp " *$") "" r in
	(lvl, Ast_org.Org(lvl, s, new_r, l, []))  )
# 530 "diff+org/org_parser.ml"
     : (int * Ast_org.org))

let _menhir_action_35 =
  fun l ->
    (
# 47 "diff+org/org_parser.mly"
    ( (max_int, Ast_org.Org(max_int, Ast_org.EMPTY, "", l,[])) )
# 538 "diff+org/org_parser.ml"
     : (int * Ast_org.org))

let _menhir_action_36 =
  fun v ->
    (
# 79 "diff+org/org_parser.mly"
                         ( Ast_org.Line v )
# 546 "diff+org/org_parser.ml"
     : (Ast_org.orgoption))

let _menhir_action_37 =
  fun v ->
    (
# 80 "diff+org/org_parser.mly"
                         ( Ast_org.ColB v )
# 554 "diff+org/org_parser.ml"
     : (Ast_org.orgoption))

let _menhir_action_38 =
  fun v ->
    (
# 81 "diff+org/org_parser.mly"
                         ( Ast_org.ColE v )
# 562 "diff+org/org_parser.ml"
     : (Ast_org.orgoption))

let _menhir_action_39 =
  fun v ->
    (
# 82 "diff+org/org_parser.mly"
                         ( Ast_org.Face v )
# 570 "diff+org/org_parser.ml"
     : (Ast_org.orgoption))

let _menhir_action_40 =
  fun p ->
    (
# 58 "diff+org/org_parser.mly"
                                     (     "/" ^ (String.concat "/" p) )
# 578 "diff+org/org_parser.ml"
     : (string))

let _menhir_action_41 =
  fun e p ->
    (
# 59 "diff+org/org_parser.mly"
                                     ( e ^ "/" ^ (String.concat "/" p) )
# 586 "diff+org/org_parser.ml"
     : (string))

let _menhir_action_42 =
  fun e ->
    (
# 62 "diff+org/org_parser.mly"
                   (e)
# 594 "diff+org/org_parser.ml"
     : (string))

let _menhir_action_43 =
  fun () ->
    (
# 88 "diff+org/org_parser.mly"
                                        ( ""              )
# 602 "diff+org/org_parser.ml"
     : (string))

let _menhir_action_44 =
  fun h t ->
    (
# 89 "diff+org/org_parser.mly"
                                        ( h ^ t )
# 610 "diff+org/org_parser.ml"
     : (string))

let _menhir_action_45 =
  fun e ->
    (
# 72 "diff+org/org_parser.mly"
                                     (e)
# 618 "diff+org/org_parser.ml"
     : (string))

let _menhir_action_46 =
  fun () ->
    (
# 73 "diff+org/org_parser.mly"
                                   ("=")
# 626 "diff+org/org_parser.ml"
     : (string))

let _menhir_action_47 =
  fun () ->
    (
# 50 "diff+org/org_parser.mly"
                                       ( Ast_org.EMPTY     )
# 634 "diff+org/org_parser.ml"
     : (Ast_org.status))

let _menhir_action_48 =
  fun s ->
    (
# 51 "diff+org/org_parser.mly"
                                       ( s                 )
# 642 "diff+org/org_parser.ml"
     : (Ast_org.status))

let _menhir_action_49 =
  fun () ->
    (
# 114 "diff+org/org_parser.mly"
                                     ( Ast_org.TODO      )
# 650 "diff+org/org_parser.ml"
     : (Ast_org.status))

let _menhir_action_50 =
  fun () ->
    (
# 115 "diff+org/org_parser.mly"
                                     ( Ast_org.OK        )
# 658 "diff+org/org_parser.ml"
     : (Ast_org.status))

let _menhir_action_51 =
  fun () ->
    (
# 116 "diff+org/org_parser.mly"
                                     ( Ast_org.UNKNOWN   )
# 666 "diff+org/org_parser.ml"
     : (Ast_org.status))

let _menhir_action_52 =
  fun () ->
    (
# 118 "diff+org/org_parser.mly"
                                     ( Ast_org.BUG       )
# 674 "diff+org/org_parser.ml"
     : (Ast_org.status))

let _menhir_action_53 =
  fun () ->
    (
# 119 "diff+org/org_parser.mly"
                                     ( Ast_org.FP        )
# 682 "diff+org/org_parser.ml"
     : (Ast_org.status))

let _menhir_action_54 =
  fun () ->
    (
# 120 "diff+org/org_parser.mly"
                                     ( Ast_org.SAME      )
# 690 "diff+org/org_parser.ml"
     : (Ast_org.status))

let _menhir_action_55 =
  fun () ->
    (
# 121 "diff+org/org_parser.mly"
                                     ( Ast_org.UNRELATED )
# 698 "diff+org/org_parser.ml"
     : (Ast_org.status))

let _menhir_action_56 =
  fun () ->
    (
# 25 "diff+org/org_parser.mly"
                                                            (      )
# 706 "diff+org/org_parser.ml"
     : (unit))

let _menhir_action_57 =
  fun () ->
    (
# 26 "diff+org/org_parser.mly"
                                                                                       ()
# 714 "diff+org/org_parser.ml"
     : (unit))

let _menhir_action_58 =
  fun () ->
    (
# 29 "diff+org/org_parser.mly"
            ()
# 722 "diff+org/org_parser.ml"
     : (unit))

let _menhir_action_59 =
  fun el ->
    (
# 85 "diff+org/org_parser.mly"
                                        ( String.concat "" el )
# 730 "diff+org/org_parser.ml"
     : (string))

let _menhir_action_60 =
  fun t ->
    (
# 92 "diff+org/org_parser.mly"
                                        ( t               )
# 738 "diff+org/org_parser.ml"
     : (string))

let _menhir_action_61 =
  fun s ->
    (
# 93 "diff+org/org_parser.mly"
                                        ( Org_helper.get_status s    )
# 746 "diff+org/org_parser.ml"
     : (string))

let _menhir_action_62 =
  fun id ->
    (
# 100 "diff+org/org_parser.mly"
                                        ( id              )
# 754 "diff+org/org_parser.ml"
     : (string))

let _menhir_action_63 =
  fun t ->
    (
# 101 "diff+org/org_parser.mly"
                                        ( t               )
# 762 "diff+org/org_parser.ml"
     : (string))

let _menhir_action_64 =
  fun i ->
    (
# 102 "diff+org/org_parser.mly"
                                        ( string_of_int i )
# 770 "diff+org/org_parser.ml"
     : (string))

let _menhir_action_65 =
  fun () ->
    (
# 103 "diff+org/org_parser.mly"
                                        ( "/"             )
# 778 "diff+org/org_parser.ml"
     : (string))

let _menhir_action_66 =
  fun () ->
    (
# 104 "diff+org/org_parser.mly"
                                        ( ":"             )
# 786 "diff+org/org_parser.ml"
     : (string))

let _menhir_action_67 =
  fun () ->
    (
# 105 "diff+org/org_parser.mly"
                                        ( "config"        )
# 794 "diff+org/org_parser.ml"
     : (string))

let _menhir_action_68 =
  fun () ->
    (
# 106 "diff+org/org_parser.mly"
                                        ( "*"             )
# 802 "diff+org/org_parser.ml"
     : (string))

let _menhir_action_69 =
  fun () ->
    (
# 107 "diff+org/org_parser.mly"
                                        ( "="             )
# 810 "diff+org/org_parser.ml"
     : (string))

let _menhir_action_70 =
  fun () ->
    (
# 108 "diff+org/org_parser.mly"
                                        ( "#+"            )
# 818 "diff+org/org_parser.ml"
     : (string))

let _menhir_action_71 =
  fun () ->
    (
# 109 "diff+org/org_parser.mly"
                                        ( "IGNORED"       )
# 826 "diff+org/org_parser.ml"
     : (string))

let _menhir_action_72 =
  fun () ->
    (
# 110 "diff+org/org_parser.mly"
                                        ( "view"          )
# 834 "diff+org/org_parser.ml"
     : (string))

let _menhir_action_73 =
  fun t ->
    (
# 96 "diff+org/org_parser.mly"
                                        ( t               )
# 842 "diff+org/org_parser.ml"
     : (string))

let _menhir_action_74 =
  fun () ->
    (
# 97 "diff+org/org_parser.mly"
                                        ( " "             )
# 850 "diff+org/org_parser.ml"
     : (string))
